...
- (void)initSubViews
{
    ...
    _facePickerView = [[UIScrollView alloc] initWithFrame:CGRectMake(kFacePanelBottomToolBarHeight, 0, SIZE_WIDTH-2*kFacePanelBottomToolBarHeight, kFacePanelBottomToolBarHeight)];
    [self addSubview:_facePickerView];
    
    _sendBtn = [UIButton buttonWithType:UIButtonTypeSystem];
    _sendBtn.frame = CGRectMake(SIZE_WIDTH-kFacePanelBottomToolBarHeight, 0, kFacePanelBottomToolBarHeight, kFacePanelBottomToolBarHeight);
