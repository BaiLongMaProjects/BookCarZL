...
@interface ChatPageViewController ()<EaseMessageViewControllerDelegate, EaseMessageViewControllerDataSource,EMClientDelegate,EMChatManagerDelegate>
{
...
{
    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 35, 24)];
...
-(void)requsetdialogAdd
{
    ...
    [params setObject:self.OtherID forKey:@"to"];
    [HttpTool postWithPath:kDialogAdd params:params success:^(id responseObj) {
        NSLog(@"chat === %@",responseObj);
...
- (id<IMessageModel>)messageViewController:(EaseMessageViewController *)viewController modelForMessage:(EMMessage *)message
{
    ...
    if (model.isSender) {
        ...
        model.avatarURLPath = self.MeHeadPhoto;
        //NSLog(@"******%@",model.avatarURLPath);
        //昵称
        model.nickname = self.MeName;
        //头像占位图
        ...
        NSLog(@"对方发送");
        //头像
        model.avatarURLPath = self.OtherHeadPhoto;
        //NSLog(@"+++++++______+++%@",model.avatarURLPath);
        //昵称
        model.nickname = self.OtherName;
        //头像占位图
        model.failImageName = @"sunlei.jpg";
